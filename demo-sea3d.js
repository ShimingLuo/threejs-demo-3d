...
import { SEA3D } from "./node_modules/three/examples/jsm/loaders/sea3d/SEA3DLoader.js";
import "./node_modules/three/examples/jsm/loaders/sea3d/SEA3DLZMA.js"; // sea3d lzma extension

import Stats from "./node_modules/three/examples/jsm/libs/stats.module.js";

console.log(
  "Visit https://github.com/sunag/sea3d to all codes and builds under development."
);
...
loader.load("https://threejs.org/examples/models/sea3d/keyframe.tjs.sea");
...
function stopAll() {
  for (var i = 0; i < loader.meshes.length; i++) {
    if (loader.meshes[i].animator) loader.meshes[i].animator.stop();
  }
}
...
function onMouseClick() {
  ...
  switch ((demoAt = ++demoAt % 4)) {
    ...
    case 2:
      ...
      fracture99.animator.play("crash#2", 0.5, 0);
